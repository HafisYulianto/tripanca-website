...
<div class="main-content">
    <div class="container-fluid">
        ...
        <form action="{{ route('kelolavisimisi.store') }}" method="POST">
            @csrf
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="visi_title" name="visi_title" value="{{ old('visi_title') }}">
                    </div>
                    <div class="mb-3">
                        <label for="visi_content" class="form-label">Konten Visi</label>
                        <textarea class="form-control" id="visi_content" name="visi_content" rows="3">{{ old('visi_content') }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="misi_title" name="misi_title" value="{{ old('misi_title') }}">
                    </div>
                    <div class="mb-3">
                        <label for="misi_content" class="form-label">Konten Misi</label>
                        <textarea class="form-control" id="misi_content" name="misi_content" rows="3">{{ old('misi_content') }}</textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" id="item1_title" name="item1_title" value="{{ old('item1_title') }}">
                        </div>
                        <div class="col-md-6">
                            <label for="item1_content" class="form-label">Konten 1</label>
                            <textarea class="form-control" id="item1_content" name="item1_content" rows="1">{{ old('item1_content') }}</textarea>
                        </div>
                    </div>
                    <!-- Item 2 -->
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" id="item2_title" name="item2_title" value="{{ old('item2_title') }}">
                        </div>
                        <div class="col-md-6">
                            <label for="item2_content" class="form-label">Konten 2</label>
                            <textarea class="form-control" id="item2_content" name="item2_content" rows="1">{{ old('item2_content') }}</textarea>
                        </div>
                    </div>
                    <!-- Item 3 -->
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" id="item3_title" name="item3_title" value="{{ old('item3_title') }}">
                        </div>
                        <div class="col-md-6">
                            <label for="item3_content" class="form-label">Konten 3</label>
                            <textarea class="form-control" id="item3_content" name="item3_content" rows="1">{{ old('item3_content') }}</textarea>
                        </div>
                    </div>
                    <!-- Item 4 -->
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" id="item4_title" name="item4_title" value="{{ old('item4_title') }}">
                        </div>
                        <div class="col-md-6">
                            <label for="item4_content" class="form-label">Konten 4</label>
                            <textarea class="form-control" id="item4_content" name="item4_content" rows="1">{{ old('item4_content') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
